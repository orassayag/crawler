/* cSpell:disable */
const { SearchEngineModel, SearchEngineStatusModel } = require('../../core/models/application');
const { SearchEngineTypeEnum, SearchPlaceHolderEnum } = require('../../core/enums');

const searchEngineStatuses = [
    new SearchEngineStatusModel({ isActive: false, name: SearchEngineTypeEnum.ASK }),
    new SearchEngineStatusModel({ isActive: false, name: SearchEngineTypeEnum.BAIDU }),
    new SearchEngineStatusModel({ isActive: true, name: SearchEngineTypeEnum.BING }),
    ...
    new SearchEngineStatusModel({ isActive: false, name: SearchEngineTypeEnum.NAVER }),
    new SearchEngineStatusModel({ isActive: false, name: SearchEngineTypeEnum.STARTPAGE }),
    new SearchEngineStatusModel({ isActive: false, name: SearchEngineTypeEnum.YANDEX })
];
...
const searchEngines = [
    ...
    new SearchEngineModel({
        ...
        startIndex: 1,
        advanceBy: 1,
        templatesList: [`web?o=0&l=dir&qo=pagination&q=${SearchPlaceHolderEnum.QUERY}&qsrc=998&page=${SearchPlaceHolderEnum.PAGER}`]
    }),
    ...
    new SearchEngineModel({
        ...
        startIndex: 0,
        advanceBy: 10,
        templatesList: [`s?wd=${SearchPlaceHolderEnum.QUERY}&pn=${SearchPlaceHolderEnum.PAGER}&oq=${SearchPlaceHolderEnum.QUERY}&ie=utf-8&rsv_idx=1&rsv_pq=99ae4b5e000440b3&rsv_t=6425vwQFWiYd3GCyuSrG4KMA1nNZb2RsGxoKzjKQNrjz1jX1I2zKg3%2FPDrc`]
    }),
...
/*             `search?q=${SearchPlaceHolderEnum.QUERY}&sp=-1&pq=&sc=0-0&qs=n&sk=&cvid=F6A9A51C2A884A459B4C65332D7506E5&first=${SearchPlaceHolderEnum.PAGER}&FORM=PORE`,
    ...
    new SearchEngineModel({
        ...
        startIndex: 0,
        advanceBy: 1,
        templatesList: [`search?p=${SearchPlaceHolderEnum.PAGER}&q=${SearchPlaceHolderEnum.QUERY}`]
    }),
    ...
    new SearchEngineModel({
        ...
        startIndex: 0,
        advanceBy: 10,
        templatesList: [`search/web/results/?q=${SearchPlaceHolderEnum.QUERY}&elements_per_page=10&start_index=${SearchPlaceHolderEnum.PAGER}`]
    }),
    ...
    new SearchEngineModel({
        ...
        startIndex: 1,
        advanceBy: 10,
        templatesList: [`search.naver?f=&fd=2&filetype=0&nso=so%3Ar%2Ca%3Aall%2Cp%3Aall&query=${SearchPlaceHolderEnum.QUERY}&research_url=&sm=tab_pge&start=${SearchPlaceHolderEnum.PAGER}&where=webkr`]
    }),
    ...
    new SearchEngineModel({
        ...
        startIndex: 1,
        advanceBy: 1,
        templatesList: [`sp/search?language=english&lui=english&t=default&query=${SearchPlaceHolderEnum.QUERY}&cat=web&page=${SearchPlaceHolderEnum.PAGER}&sc=CzFATGXE3M2x00`]
    }),
    ...
    new SearchEngineModel({
        ...
        startIndex: 0,
        advanceBy: 1,
        templatesList: [`search/?lr=131&text=${SearchPlaceHolderEnum.QUERY}&p=${SearchPlaceHolderEnum.PAGER}&redircnt=1580916510.1`]
    })
];
