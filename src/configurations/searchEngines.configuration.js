...
const searchEngines = [
    ...
    new SearchEngine({
        ...
        startIndex: 1,
        advanceBy: 1,
        templateAddress: `https://www.ask.com/web?o=0&l=dir&qo=pagination&q=${SearchPlaceHolder.QUERY}&qsrc=998&page=${SearchPlaceHolder.PAGER}`
    }),
    // Baidu.com
    new SearchEngine({
        ...
        startIndex: 0,
        advanceBy: 10,
        templateAddress: `https://www.baidu.com/s?wd=${SearchPlaceHolder.QUERY}&pn=${SearchPlaceHolder.PAGER}&oq=${SearchPlaceHolder.QUERY}&ie=utf-8&rsv_idx=1&rsv_pq=99ae4b5e000440b3&rsv_t=6425vwQFWiYd3GCyuSrG4KMA1nNZb2RsGxoKzjKQNrjz1jX1I2zKg3%2FPDrc`
    }),
    // Bing.com
    new SearchEngine({
        ...
        startIndex: 1,
        advanceBy: 10,
        templateAddress: `https://www.bing.com/search?q=${SearchPlaceHolder.QUERY}&qs=n&sp=-1&pq=%d7%93&sc=0-1&sk=&cvid=AD0065E122BA4D3BA69164098163F923&first=${SearchPlaceHolder.PAGER}&FORM=PERE`
    }),
    // Dogpile.com
    new SearchEngine({
    ...
    new SearchEngine({
        ...
        startIndex: 0,
        advanceBy: 1,
        templateAddress: `https://www.ecosia.org/search?p=${SearchPlaceHolder.PAGER}&q=${SearchPlaceHolder.QUERY}`
    }),
    // Exalead.com
    new SearchEngine({
        ...
        startIndex: 0,
        advanceBy: 10,
        templateAddress: `https://www.exalead.com/search/web/results/?q=${SearchPlaceHolder.QUERY}&elements_per_page=10&start_index=${SearchPlaceHolder.PAGER}`
    }),
    // Google.com
    new SearchEngine({
        ...
        startIndex: 0,
        advanceBy: 10,
        templateAddress: `https://www.google.com/search?q=${SearchPlaceHolder.QUERY}&newwindow=1&rlz=1C1CHBF_enIL821IL821&sxsrf=ALeKk027eS7uL7BbX5n3A9_9Kyx5V-cv9Q:1588938694912&ei=xke1XtOZN4yWsAfan6-4DQ&start=${SearchPlaceHolder.PAGER}&sa=N&ved=2ahUKEwjTlOvzmaTpAhUMC-wKHdrPC9cQ8NMDegQIDRA5&biw=1920&bih=937`
    }),
    // Info.com
    new SearchEngine({
    ...
    new SearchEngine({
        ...
        startIndex: 1,
        advanceBy: 10,
        templateAddress: `https://search.naver.com/search.naver?f=&fd=2&filetype=0&nso=so%3Ar%2Ca%3Aall%2Cp%3Aall&query=${SearchPlaceHolder.QUERY}&research_url=&sm=tab_pge&start=${SearchPlaceHolder.PAGER}&where=webkr`
    }),
    // StartPage.com
    new SearchEngine({
        ...
        startIndex: 1,
        advanceBy: 1,
        templateAddress: `https://www.startpage.com/sp/search?language=english&lui=english&t=default&query=${SearchPlaceHolder.QUERY}&cat=web&page=${SearchPlaceHolder.PAGER}&sc=CzFATGXE3M2x00`
    }),
    // Yandex.com
    new SearchEngine({
        ...
        startIndex: 0,
        advanceBy: 1,
        templateAddress: `https://yandex.com/search/?lr=131&text=${SearchPlaceHolder.QUERY}&p=${SearchPlaceHolder.PAGER}&redircnt=1580916510.1`
    })
];

module.exports = { searchEngineStatuses, searchEngines };