...
const advanceSearchKeys = [
    ...
    [
        ...
        new SearchKey({ keyType: SearchKeyType.PERSON, maleKey: 'רפרנט', femaleKey: 'רפרנטית', bothKey: 'רפרנט/ית' })
    ],
    // ===PROFESSION=== //
    [
    ...
    // ===CITY=== //
    [
        new SearchKey({ keyType: SearchKeyType.CITY, globalKey: 'אודים' }),
        new SearchKey({ keyType: SearchKeyType.CITY, globalKey: 'ארסוף' }),
        new SearchKey({ keyType: SearchKeyType.CITY, globalKey: 'הוד"ש' }),
        new SearchKey({ keyType: SearchKeyType.CITY, globalKey: 'הרצליה' }),
        new SearchKey({ keyType: SearchKeyType.CITY, globalKey: 'ינוב' }),
        new SearchKey({ keyType: SearchKeyType.CITY, globalKey: 'כפ"ס' }),
        new SearchKey({ keyType: SearchKeyType.CITY, globalKey: 'נירית' }),
        new SearchKey({ keyType: SearchKeyType.CITY, globalKey: 'נתניה' }),
        new SearchKey({ keyType: SearchKeyType.CITY, globalKey: 'פ"ת' }),
        new SearchKey({ keyType: SearchKeyType.CITY, globalKey: 'פרדסיה' }),
        new SearchKey({ keyType: SearchKeyType.CITY, globalKey: 'צופית' }),
        new SearchKey({ keyType: SearchKeyType.CITY, globalKey: 'צורן' }),
        ...
        new SearchKey({ keyType: SearchKeyType.CITY, globalKey: 'שפיים' }),
        new SearchKey({ keyType: SearchKeyType.CITY, globalKey: 'תנופות' }),
        new SearchKey({ keyType: SearchKeyType.CITY, isMiddleReplace: true, globalKey: 'אבן יהודה' }),
        new SearchKey({ keyType: SearchKeyType.CITY, isMiddleReplace: true, globalKey: 'בית ינאי' }),
        ...
        new SearchKey({ keyType: SearchKeyType.CITY, isMiddleReplace: true, globalKey: 'כפר יונה' }),
        ...
        new SearchKey({ keyType: SearchKeyType.CITY, isMiddleReplace: true, globalKey: 'עמק חפר' }),
        new SearchKey({ keyType: SearchKeyType.CITY, isMiddleReplace: true, globalKey: 'פתח תקווה' }),
        new SearchKey({ keyType: SearchKeyType.CITY, isMiddleReplace: true, globalKey: 'צור יגאל' }),
        new SearchKey({ keyType: SearchKeyType.CITY, isMiddleReplace: true, globalKey: 'קדימה צורן' }),
        new SearchKey({ keyType: SearchKeyType.CITY, isMiddleReplace: true, globalKey: 'ראש העין' }),
