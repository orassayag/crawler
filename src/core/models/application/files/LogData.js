class LogData {
	...
	constructor(settings) {
		...
		const { IS_EMPTY_DIST_DIRECTORY, IS_LOG_VALID_EMAIL_ADDRESSES, IS_LOG_FIX_EMAIL_ADDRESSES, IS_LOG_INVALID_EMAIL_ADDRESSES,
			...
			MAXIMUM_FIX_LOG_SPACES_CHARACTERS_COUNT } = settings;
		...
		this.isLogGibberishEmailAddresses = IS_LOG_GIBBERISH_EMAIL_ADDRESSES;
		this.isLogCrawlLinks = IS_LOG_CRAWL_LINKS;
		this.isLogCrawlErrorLinks = IS_LOG_CRAWL_ERROR_LINKS;
		this.maximumFixLogSpacesCharactersCount = MAXIMUM_FIX_LOG_SPACES_CHARACTERS_COUNT;
	}
}
